...
class Parameters {
public:
    Parameters(juce::AudioProcessorValueTreeState& aptvs);
    ...
    static constexpr float maxDelayTime = 5000.0f; // in milliseconds, so max time delay 5 seconds
