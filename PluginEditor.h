...
private:
    ...
    RotaryKnob gainKnob{ "Gain", audioProcessor.apvts, gainParamID, true }; //true means start knob in the middle
    ...
    RotaryKnob lowCutKnob{ "Low Cut", audioProcessor.apvts, lowCutParamID }; //added to user interface here
